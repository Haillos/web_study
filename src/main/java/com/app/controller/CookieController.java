...
public class CookieController {
	...
	public String saveCookie(HttpServletResponse response) {
		...
		// 띄어쓰기 => URLEncode
		try {
			String tempValue = URLEncoder.encode("temp cookie value", "UTF-8");
			Cookie ck2 = new Cookie("temp", "temp_cookie");
			response.addCookie(ck2);

			Cookie ck3 = new Cookie("temp2", MyCookieUtil.encodeCookieValue("22 value test"));

			Cookie ck4 = MyCookieUtil.createCookie("ck5name", "ck5Value", 120);
			ck4.setMaxAge(40);
